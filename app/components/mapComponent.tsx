...
export default function MapComponent() {
  ...
  const gapScores = [
    0.25, 0.28, 0.32, 0.35, 0.9, 0.82, 0.43, 0.48, 0.52, 0.55, 0.58, 0.62, 0.65,
    0.68, 0.72, 0.75, 0.78, 0.82, 0.85, 0.88, 0.32, 0.35, 0.90, 0.42, 0.43,
    0.48, 0.52, 0.55, 0.58, 0.62, 0.65, 0.68, 0.72, 0.75, 0.78, 0.82, 0.85,
    0.88, 0.74, 0.95, 0.82, 0.42, 0.43, 0.48, 0.52, 0.55, 0.58, 0.62, 0.65,
    0.68,
  ];
